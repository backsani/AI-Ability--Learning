...
/// and the closing evaluation. The evaluation rubric mirrors the 5 항목 and 6단계 프롬프트 패턴
/// pattern inferred from published AI-usage hiring assessments, so the report teaches to that shape.
/// </summary>
public static class PromptBuilder
{
    ...
    public static string BuildProblemGenerationPrompt(PracticeConfig config, List<string> avoidTitles)
    {
        ...
        return $$"""
        너는 "AI 활용 능력 평가" 대비 연습 프로그램의 문제 출제자다. 최근 기업 채용에서
        "실제 업무와 유사한 문제를 주어진 AI 도구와 함께 해결"하도록 요구하는 경향을 반영해,
        ...
        string durationLabel, bool endedEarly)
    {
        ...
        return $$"""
        너는 "AI 활용 능력 평가" 대비 연습 프로그램의 평가자다. 목적은 사용자를 줄 세우는 것이
